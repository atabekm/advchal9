...
Beyond task1 this client accepts the response-control parameters -- max_tokens,
stop, response_format -- and reports what the API did with them, which is what
makes two runs comparable. Metrics are available either way: DeepSeek puts the
usage block and finish_reason in the final chunk of a streamed response too.
"""
